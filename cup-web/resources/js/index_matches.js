...
document.addEventListener("DOMContentLoaded", function() {
    let showMoreInfoMatchesIcon = document.getElementById("showMoreInfoMatchesIcon");
    if(showMoreInfoMatchesIcon){
        showMoreInfoMatchesIcon.addEventListener("click", () => {
            showMoreInfoMatches();
        })
    }
    let openSelectWeeksFormIcon = document.getElementById("openSelectWeeksFormIcon");
    if(openSelectWeeksFormIcon){
        openSelectWeeksFormIcon.addEventListener("click", () => {
            openSelectWeeksForm();
        })
    }
});