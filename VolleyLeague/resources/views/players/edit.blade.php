                ...
                <form class="create-player-form"
                    ...
                    <div class="form-group section-form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="league_id" rows="1"
                                value={{ $league->league_id }} required readonly>
                        </div>
                        <div class="form-group">
                            <label for="league_name">League Name:</label>
                            <input type="text" class="form-control" name="league_name" rows="1"
                                value={{ $league->league_name }} required readonly>
                        </div>
                        <div class="form-group">
                            <label for="team_id">Team ID:</label>
                            <input type="text" class="form-control" id="team_id" name="team_id" rows="1"
                                value={{ $team->team_id }} required readonly>
                        </div>

                        <div class="form-group">
                            <label for="team_name">Team Name:</label>
                            <input type="text" class="form-control" id="team_name" name="team_number" rows="1"
                                value={{ $team->team_name }} required readonly>
                        </div>
                        <!--PLAYER NAME -->
                        <div class="form-group">
                            <label for="player_name">Player Name:</label>
                            <input type="text" class="form-control" name="player_name" rows="1"
                                value="{{ $player->name ?? '' }}" required>
                        </div>
                        <div class="form-group">
                            <label for="player_surname_1">Player 1st Surname:</label>
                            <input type="text" class="form-control" name="player_surname_1" rows="1"
                                value="{{ $player->surname_1 ?? '' }}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="player_birth_date">Player Birth Date:</label>
                            <input type="date" class="form-control" name="player_birth_date"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" name="player_height"
                                rows="1" value="{{ $player->height ?? '' }}">
                        </div>
                        <div class="form-group">
                            <label for="player_weight">Player Weight:</label>
                            <input type="number" step="0.01" class="form-control" name="player_weight"
                                rows="1" value="{{ $player->weight ?? '' }}">
                        </div>

                        <!--Player IMAGE -->
                        <div class="form-group">
                            <label for="player_img">Player Image:</label>
                            <input class="form-control" type="file" id="team_img" name="player_img"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="player_email" rows="1"
                    ...
                    <div class="actions-row">
                        ...
                        <a href="{{ route('players.index', ['league' => $league->league_id, 'team' => $team->team_id]) }}"
                            class="btn-cancel">
