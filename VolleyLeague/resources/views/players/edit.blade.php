				...
				<form class="create-player-form" action="{{ route('players.update', ['league'=> $league->league_id, 'team'=> $team->team_id, 'player'=> $player->player_id]) }}" method="post" enctype="multipart/form-data">
					...
					<div class="form-group section-form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="player_name" rows="1" value="{{$player->name ?? ""}}" required>
						</div>
						<div class="form-group">
							<label for="player_surname_1">Player 1st Surname:</label>
							<input type="text" class="form-control" name="player_surname_1" rows="1" value="{{$player->surname_1 ?? ""}}" required>
						</div>
						<div class="form-group">
							<label for="player_surname_2">Player 2nd Surname:</label>
							<input type="text" class="form-control" name="player_surname_2" rows="1" value="{{$player->surname_2 ?? ""}}">
						</div>
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" name="player_number" rows="1" value="{{$player->player_number ?? ""}}">
						</div>
						
						<div class="form-group">
							<label for="player_birth_date">Player Birth Date:</label>
							<input type="date"  class="form-control" name="player_birth_date" value="{{$player->birth_date ?? ""}}" required>
						</div>
						
						<div class="form-group">
							<label for="player_country">Player Origin Country:</label>
							<input type="text" class="form-control" name="player_country" rows="1" value="{{$player->country ?? ""}}" >
						</div>
						
						<div class="form-group">
							<label for="player_height">Player Height:</label>
							<input type="number" step="0.01"  class="form-control" name="player_height" rows="1" value="{{$player->height ?? ""}}">
						</div>
						<div class="form-group">
							<label for="player_weight">Player Weight:</label>
							<input type="number" step="0.01"  class="form-control" name="player_weight" rows="1" value="{{$player->weight ?? ""}}" >
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="player_phone" rows="1" value="{{$player->phone ?? ""}}" >
						</div>
						
						<!--Player EMAIL -->
						<div class="form-group">
							<label for="player_email">Player E-Mail:</label>
							<input type="email" class="form-control" name="player_email" rows="1" value="{{$player->email ?? ""}}" required>
						</div>
