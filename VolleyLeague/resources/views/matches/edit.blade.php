        ...
        <div class="match-main-container">
            <form class="match-edit-form"
                ...
                <div class="form-group-hidden">
                    ...
                    <input type="text" class="form-control" id="match_id" name="match_id" rows="1"
                        value={{ $match->match_id }} required>
                ...
                <div class="form-group-match section-form-group-match">
                    ...
                    <div class="match-number-container">
                        ...
                        <input type="text" class="form-control" id="match_number" name="match_number" rows="1"
                            value={{ $match->match_number }} readonly required>
                    </div>

                    <div class="match-number-container">
                        <label for="week_number">Week number:</label>
                        <input type="number" class="form-control" id="week_number" name="week_number"
                            value="{{ $match->week_number }}" required>
                    </div>
                ...
                <div class="form-group section-form-group">
                    ...
                    <input type="text" class="form-control" id="match_address_country" name="match_address_country"
                        rows="1" value="{{ $match_address->country ?? '' }}">

                    <label for="match_address_postalcode">Postal Code:</label>
                    <input type="text" class="form-control" id="match_address_postalcode"
                        name="match_address_postalcode" rows="1" value="{{ $match_address->postalcode ?? '' }}">

                    <label for="match_address_city">City:</label>
                    <input type="text" class="form-control" id="match_address_city" name="match_address_city"
                        rows="1" value="{{ $match_address->city ?? '' }}">

                    <label for="match_address_street">Street:</label>
                    <input type="text" class="form-control" id="match_address_street" name="match_address_street"
                        rows="1" value="{{ $match_address->street ?? '' }}">

                    <label for="match_address_number">Street Number:</label>
                    <input type="text" class="form-control" id="match_address_number" name="match_address_number"
                        rows="1" value="{{ $match_address->number ?? '' }}">

                    <label for="match_address_floor">Floor:</label>
                    <input type="text" class="form-control" id="match_address_floor" name="match_address_floor"
                        rows="1" value="{{ $match_address->floor ?? '' }}">

                    <label for="match_address_door">Door:</label>
                    <input type="text" class="form-control" id="match_address_door" name="match_address_door"
                        rows="1" value="{{ $match_address->door ?? '' }}">
                </div>
