...
<body>
	...
	<main>
		...
		<div class="create-team-container">
			<div class="create-team-inner-container">
				<h3>Create a new match:</h3>
				<form class="create-match-form" action="{{ route('matches.store', $league->league_id) }}" method="post" enctype="multipart/form-data">
					@csrf
					@method('POST')
					...
					<div class="form-group-main section-form-group">
						...
						<div class="form-group">
							...
							<input type="text"  class="form-control" id="match_number" name="match_number" rows="1" value={{$next_match_number}} required readonly>
						</div>
					...
					<div class="form-group section-form-group">
						...
						<div class="form-group">
							...
							<input type="text"  class="form-control" id="match_address_country" name="match_address_country" rows="1"  >
							
							<label for="match_address_postalcode">Postal Code:</label>
							<input type="text"  class="form-control" id="match_address_postalcode" name="match_address_postalcode" rows="1"  >
							
							<label for="match_address_city">City:</label>
							<input type="text"  class="form-control" id="match_address_city" name="match_address_city" rows="1" >
							
							
							<label for="match_address_street">Street:</label>
							<input type="text"  class="form-control" id="match_address_street" name="match_address_street" rows="1" >
							
							<label for="match_address_number">Street Number:</label>
							<input type="text"  class="form-control" id="match_address_number" name="match_address_number" rows="1" >
							
							<label for="match_address_floor">Floor:</label>
							<input type="text" class="form-control" id="match_address_floor" name="match_address_floor" rows="1" >
							
							<label for="match_address_door">Door:</label>
							<input type="text" class="form-control" id="match_address_door" name="match_address_door" rows="1" >
						</div>
					</div>
