    ...
    <main>
        ...
        <div class="create-league-container">
            <div class="create-league-inner-container">
                <h3>Update league</h3>
                <form class="edit-league-form" action="{{ route('leagues.update', $league->league_id) }}" method="post"
                    ...
                    <div class="form-group section-form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="league_name" name="league_name" rows="1" value="{{ $league->league_name }}"
                                required>{{ $league->league_name }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="league_starting_date"
                                name="league_starting_date" value="{{ $league->league_starting_date }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="datetime-local" class="form-control" id="league_finalization_date"
                                name="league_finalization_date" value="{{ $league->league_finalization_date }}"
                                required>
                        </div>
                    </div>
