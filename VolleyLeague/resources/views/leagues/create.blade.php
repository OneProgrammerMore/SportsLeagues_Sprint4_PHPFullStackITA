	...
	<main>
		...
		<div class="create-league-container">
			<div class="create-league-inner-container">
				...
				<form class="create-league-form" action="{{ route('leagues.store') }}" method="post" enctype="multipart/form-data">
					@csrf
					...
					<div class="form-group section-form-group">
						...
						<div class="form-group">
							...
							<input type="datetime-local"  class="form-control" id="league_starting_date" name="league_starting_date" required>
						</div>
						...
						<div class="form-group">
							...
							<input type="datetime-local"  class="form-control" id="league_finalization_date" name="league_finalization_date" required>
						</div>
					</div>
