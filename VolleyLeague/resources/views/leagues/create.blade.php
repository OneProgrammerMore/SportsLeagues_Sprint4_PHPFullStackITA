    ...
    <main>
        ...
        <div class="create-league-container">
            <div class="create-league-inner-container">
                ...
                <form class="create-league-form" action="{{ route('leagues.store') }}" method="post"
                    ...
                    <div class="form-group section-form-group">
                        ...
                        <div class="form-group">
                            <label for="league_name">League Name: <span class="required">*</span></label><br>
                            <textarea class="form-control" id="league_name" name="league_name" rows="1" required></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="league_img" class="input-image" name="league_img"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="league_official_web" name="league_official_web" />
                        </div>

                        <div class="form-group">
                            <label for="league_description">League Description:</label><br>
                            <textarea type="text" id="league_description" name="league_description" rows="4" cols="15" /></textarea>
                        </div>

                        <div class="form-group">
                            <label for="league_starting_date">League Starting Date:
                                <span class="required">*</span>
                            </label>
                            <input type="datetime-local" class="form-control" id="league_starting_date"
                                name="league_starting_date" required>
                        </div>

                        <div class="form-group">
                            <label for="league_finalization_date">League Finalization Date:
                                <span class="required">*</span>
                            </label>
                            <input type="datetime-local" class="form-control" id="league_finalization_date"
                                name="league_finalization_date" required>
                        </div>
                    </div>
