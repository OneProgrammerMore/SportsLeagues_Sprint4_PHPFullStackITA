                        ...
                        <div class="league-info">
                            ...
                            <div class="league-data">
                                ...
                                <h3 class="league-date">
                                    <h2 class="title-bold">Starting on:</h2> {{ $league->league_starting_date ?? '' }}
                                </h3>
                                <h3 class="league-date">
                                    <h2 class="title-bold">Finishig on:</h2> {{ $league->league_starting_date ?? '' }}
                                </h3>
                        ...
                        <div class="league-interactions-all">
                            ...
                            <div class="form-actions">
                                ...
                                <form class="league-info-link league-link"
                                    action="{{ route('leagues.edit', $league->league_id) }}" method="post">
                                    @csrf
                                    @method('GET')
                                ...
                                <form class="league-info-link league-link"
                                    action="{{ route('leagues.destroy', $league->league_id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
