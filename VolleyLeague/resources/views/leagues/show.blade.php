            ...
            <div class="league-container-show">
                <div class="league-info-show">
                    <div class="league-img-show">
                        <img src="{{ asset($league->league_img_name ? 'storage/public/' . $league->league_img_name : 'img/league.png') }}"
                    ...
                    <div class="league-data">
                        ...
                        <div class="league-show-group">
                            ...
                            <h3 class="league-data-field">
                                <a href="{{ $league->league_official_web }}"> {{ $league->league_official_web }} </a>
                            </h3>
                        </div>
                        ...
                        <div class="league-show-group">
                            ...
                            <h3 class="league-data-field">
                                <a href="{{ $league->league_channel }}">{{ $league->league_channel }} </a>
                ...
                <div class="league-actions-show">
                    ...
                    <form class="league-info-link league-link" action="{{ route('leagues.edit', $league->league_id) }}"
                        method="post">
                        @csrf
                        @method('GET')
