...
{{ $team->team_name }}</textarea
                        ...
                        <div class="form-group section-form-group">
                            ...
                            <div class="form-group">
                                <label for="team_address_country">
                                    Country:
                                </label>
                                <input
                                    type="text"
                        ...
                        <div class="form-group section-form-group">
                            ...
                            <div class="form-group">
                                <label
                                    for="team_responsible_address_postalcode"
                                >
                                    Team Postal Code:
                                </label>
                                <input
