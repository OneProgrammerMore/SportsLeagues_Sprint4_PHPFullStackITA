                ...
                <div class="league-info-show">
                    ...
                    <div class="team-info-main">
                        <div class="team-data">
                            ...
                            <h3 class="team-address">
                                ...
                                {{ $team_address->door ? $team_address->door . ' Door' : '' }} <br>
                    ...
                    <div class="team-responsible-info team-info-main">
                        <div class="team-data">
                            ...
                            <h3 class="team-responsible-name">{{ $team_responsible->person_surname_1 ?? '' }}
                                {{ $team_responsible->person_surname_2 ?? '' }}
                                {{ $team_responsible->person_name ?? '' }}</h3>
                            ...
                            <h3 class="team-responsible-address">
                                ...
                                {{ $team_responsible_address->number ?? '' }} <br>
                                ...
                                {{ $team_responsible_address->postalcode ?? '' }} <br>
